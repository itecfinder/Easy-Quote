...
import { ArrowRight, Store, TrendingDown, TrendingUp, Check } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-in-fade max-w-3xl mx-auto">
      ...
      <div className="flex justify-between">
        <Button variant="outline" onClick={() => go('estimate')}>Back</Button>
        <Button onClick={() => go('invoice')}>Continue to Invoice <ArrowRight className="ml-2 h-4 w-4" /></Button>
      </div>
    </div>
  );
}
