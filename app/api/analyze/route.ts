...
import { MAX_FREE_ESTIMATES, type LineItem, type ScanResult } from '@/lib/constants';
...
export async function POST(req: Request) {
  try {
    ...
    // Enforce free estimate limit.
    if (session.memberType === 'free') {
